				...
				<div class="headerMenu">
					...
					<div class="mainMenu">
						<ul>
							...
							<li><a href="http://localhost:8080/toalGame/gamelink">게임 링크</a></li>
							<li><a href="http://localhost:8080/toalGame/favorites">즐겨찾기</a></li>
							<li><a href="http://localhost:8080/toalGame/community">게시판</a></li>
						</ul>	
					</div>
					<div class="loginMenu">
						<ul>
							...
							%>
								<li class="login"><a href="http://localhost:8080/toalGame/login">로그인</a></li>
								<li class="signUp"><a href="http://localhost:8080/toalGame/signup">회원 가입</a></li>
							...
							%>
								<div class="myMenu">
									<ul>
										<li><a href="http://localhost:8080/toalGame/mypage">마이페이지</a></li>
										<%
										if(session.getAttribute("grade") == "관리자"){
										%>
										<li><a href="http://localhost:8080/toalGame/adminpage">관리자 페이지</a></li>
										<%
											}
										%>
										<li><a href="http://localhost:8080/toalGame/logout">로그아웃</a></li>
									</ul>
								</div>
							</li>
						</ul>
